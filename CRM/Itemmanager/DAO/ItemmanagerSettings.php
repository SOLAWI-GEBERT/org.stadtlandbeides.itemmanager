 ...
 * (GenCodeChecksum:c1cc81f1f9898fb7f58feafa8e979e6a)
 */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'price_field_id' => [
          'name' => 'price_field_id',
          'type' => CRM_Utils_Type::T_INT,
          'title' => CRM_Itemmanager_ExtensionUtil::ts('Price Field'),
          'description' => CRM_Itemmanager_ExtensionUtil::ts('FK to civicrm_price_field'),
          'required' => TRUE,
          'where' => 'civicrm_itemmanager_settings.price_field_id',
          'table_name' => 'civicrm_itemmanager_settings',
          'entity' => 'ItemmanagerSettings',
          'bao' => 'CRM_Itemmanager_DAO_ItemmanagerSettings',
          'localizable' => 0,
        ...
        'period_type' => [
          ...
          'description' => CRM_Itemmanager_ExtensionUtil::ts('Period intervall type'),
