 ...
 */
class CRM_Itemmanager_Logic_RenewalMultipleInstallmentPlan extends CRM_Itemmanager_Logic_RenewalPaymentPlanBase {
  ...
  private function createRecurringContribution($contributionParams=null) {
    ...
    $this->paymentPlanStartDate = $this->newPeriodStartOn;
...
//  ToDo: Install Mmbership Extras  CRM_MembershipExtras_Service_CustomFieldsCopier::copy(
