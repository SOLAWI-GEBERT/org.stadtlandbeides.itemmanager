...
//
  ...
  public function addLineItemPrototype($itemmanagerID,$quantity){
      ...
      $lineItemParams = [
          ...
          'qty' => $quantity,
          'unit_price' => CRM_Utils_Money::format($unit_price, NULL, NULL, TRUE),
          'line_total' => CRM_Utils_Money::format($total, NULL, NULL, TRUE),
          'tax_amount' => CRM_Utils_Money::format($new_tax, NULL, NULL, TRUE),
